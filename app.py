...
def predict():
    ...
    if request.method == 'POST':
        ...
        prediction=model.predict([[vehicle_age,km_driven,present_price,mileage,seller_type_Dealer,seller_type_Individual,fuel_type_CNG,fuel_type_Diesel,fuel_type_Petrol,transmission_type_Automatic,transmission_type_Manual]])
